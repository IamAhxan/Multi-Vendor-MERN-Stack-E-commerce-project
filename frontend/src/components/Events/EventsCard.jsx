...
const EventsCard = ({ active, data }) => {
    ...
    return (
        <div className={`w-full block bg-white rounded-lg ${active ? "unset" : "mb-12"} lg:flex p-2 mb-12`}>
            ...
            <div className="w-full lg:[w-50%] flex flex-col justify-center ml-4">
                <h2 className={`${styles.productTitle}`}>{data.name}</h2>
                <p>{data.description}</p>
                <div className="flex py-2 justify-between">
                    <div className="flex">
                        <h5 className="font-[500] text-[18px] text-[#d55d45] pr-3 line-through">
                            {data.originalPrice}$
                        </h5>
                ...
                <div className="flex items-center">
                    ...
                    <div className={`${styles.button} text-white ml-5`} onClick={() => addToCartHandler(data)}>Add to Cart</div>
                </div>
